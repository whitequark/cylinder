...
(* OASIS_START *)
(* DO NOT EDIT (digest: 45b2f2fa57919e456ed6d1d1e7cf6b33) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_cylinder", ["-runner"; "sequential"]))
                   ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/whitequark/cylinder";
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("sodium",
                               Some (OASISVersion.VGreaterEqual "0.1"))
                        ];
                   ...
                   {
                      lib_modules = ["Pathname"; "Timestamp"; "Tree"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "cylinder"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "cylinderd.ml"});
               Executable
                 ({
                     cs_name = "test_cylinder";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_cylinder.ml"});
               Test
                 ({
                     cs_name = "inotify";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/whitequark/cylinder.git";
                      src_repo_browser =
                        Some "https://github.com/whitequark/cylinder";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "NR\174?I4\171\195\218\127\185\170\230=\151h";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
