...
(* OASIS_START *)
(* DO NOT EDIT (digest: 320005c1059b3f74fe9570caae4fbcd4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_cylinder", []))];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("inotify.lwt", None)
                        ];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\190K6\005,\239\154\252\153\n\150\130\248\204\205\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
